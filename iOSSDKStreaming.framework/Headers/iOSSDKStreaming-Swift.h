// Generated by Apple Swift version 5.5 (swiftlang-1300.0.20.104 clang-1300.0.21.1)
#ifndef IOSSDKSTREAMING_SWIFT_H
#define IOSSDKSTREAMING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="iOSSDKStreaming",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (void)audioSession:(RTCAudioSession * _Nonnull)audioSession didReceive:(CMSampleBufferRef _Nonnull)sample;
